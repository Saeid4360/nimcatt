...
const textAssets = {
  ...
  "/editorial-desk": await readFile(resolve(distRoot, "editorial-desk.html"), "utf8"),
  "/editorial-desk.html": await readFile(resolve(distRoot, "editorial-desk.html"), "utf8"),
  ...
  "/data/daily-features.js": await readFile(resolve(distRoot, "data/daily-features.js"), "utf8"),
  "/data/daily-features-2.js": await readFile(resolve(distRoot, "data/daily-features-2.js"), "utf8"),
